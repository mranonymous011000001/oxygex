...
class MyTheme {
  ...
  static const Color grayBg = Color(0xFF14171E);
  static const Color accent = Color(0xFF00B4D8);
  static const Color accent50 = Color(0x7700B4D8);
  static const Color accent80 = Color(0xAA00B4D8);
  static const Color canvasColor = Color(0xFF0A0C10);
  static const Color border = Color(0xFF2D3440);
  static const Color idColor = Color(0xFF48CAE4);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF0096C7);
  static const Color hoverBorder = Color(0xFF48CAE4);
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    hoverColor: Color.fromARGB(255, 40, 48, 60),
    scaffoldBackgroundColor: Color(0xFF0A0C10),
    dialogBackgroundColor: Color(0xFF14171E),
    appBarTheme: AppBarTheme(
      shadowColor: Colors.transparent,
    ),
    dialogTheme: DialogTheme(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(color: Color(0xFF2D3440), width: 0.5),
        disabledForegroundColor: Colors.white70,
        foregroundColor: Colors.white70,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(8.0),
